...
(facts
 ...
 (fact (sqlite3-to-clj-type [:name "tinytext"]) => {:name {:type :string :max-chars 255}})
 (fact (sqlite3-to-clj-type [:name "text"]) => {:name {:type :string :max-chars 65535}})
 (fact (sqlite3-to-clj-type [:name "mediumtext"]) => {:name {:type :string :max-chars 16777215}})
 (fact (sqlite3-to-clj-type [:name "longtext"]) => {:name {:type :string :max-chars 4294967295}}))
